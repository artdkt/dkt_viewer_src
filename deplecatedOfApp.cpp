...
void DofApp::setup() {
  ...
  section_1->zoomToggle.addListener(this, &DofApp::onZoomChanged_1);
...
//--------------------------------------------------------------
void DofApp::keyPressed(int key){
...
//--------------------------------------------------------------
void DofApp::keyReleased(int key){
  
}

//--------------------------------------------------------------
void DofApp::allMoviePlay(bool _bool){
...
//--------------------------------------------------------------
void DofApp::mouseMoved(int x, int y ){
...
//--------------------------------------------------------------
void DofApp::mouseDragged(int x, int y, int button){
...
//--------------------------------------------------------------
void DofApp::mousePressed(int x, int y, int button){
...
//--------------------------------------------------------------
void DofApp::mouseReleased(int x, int y, int button){
...
//--------------------------------------------------------------
void DofApp::windowResized(int w, int h){
  
}

//--------------------------------------------------------------
void DofApp::gotMessage(ofMessage msg){
  
}

//--------------------------------------------------------------
void DofApp::dragEvent(ofDragInfo dragInfo){
...
bool DofApp::checkingdoubleClicked() {
...
void DofApp::manipulateZooms(int sectionNum) {
  ForceFalsedZoomFlags(sectionNum);
  convertDisplaysZooming();
}

void DofApp::ForceFalsedZoomFlags(int sectionNum) {
...
void DofApp::convertDisplaysZooming() {
...
/* ---------------- events function --------------------*/
void DofApp::onZoomChanged_1(bool &state) {
